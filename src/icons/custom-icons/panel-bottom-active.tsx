...
export const CustomPanelBottomActive = React.forwardRef<
  SVGSVGElement,
  CustomIconProps
>(({ size: rawSize = "md", ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <path
        d="M21,15l-18,0l0,4c0,1.104 0.896,2 2,2l14,0c1.104,0 2,-0.896 2,-2l0,-4Z"
        fill="currentColor"
      />
    </svg>
  );
...
CustomPanelBottomActive.displayName = "CustomPanelBottomActive";
